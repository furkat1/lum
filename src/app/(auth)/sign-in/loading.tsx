      ...
      >
        ...
        >
          ...
          <Skeleton
            width={166}
            height={17}
            sx={{ backgroundColor: palette.light_grey, marginLeft: "auto" }}
          />

          <Skeleton width={262} height={26 / 0.7} sx={{ backgroundColor: palette.light_grey }} />

          <Skeleton width="100%" height={89 / 0.7} sx={{ backgroundColor: palette.light_grey }} />
